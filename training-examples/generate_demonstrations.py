'''
This script has been adapted from Kai Mo's scripts for Foldsformer the way it was originally implemented.
'''
import argparse
import numpy as np
...
def main():
    ...
    # save settings
    save_path = os.path.join(parent_directory, "data", "gpt-4v-incontext-demonstrations", args.task)
